...
urlpatterns = [
    ...
    url(r'^compute/comment/$', views.compute_sentiment_comment, name='compute_comment'),
    url(r'^$', views.crawler, name='home'),
    url('^download/$', views.download_comment, name='download'),
    url('^compute/$', views.compute_brand_product, name='compute_brand_product'),
    # url(r'^download_comment/$', views.download_comment,name='download_comment'),
